import { e3 as dispatchMediaLoadedEvent, e4 as dispatchMediaVolumeChangeEvent, e5 as dispatchMediaPlayEvent, e6 as dispatchMediaPauseEvent, u as s, B as errorToConsole, l as localize, ea as createProxiedEndpointIfNecessary, eb as homeAssistantSignPath, a4 as renderMessage, C as x, v as r, _ as __decorate, y as n, x as r$1, t } from './card-edc26888.js';
import { d as dispatchLiveErrorEvent } from './dispatch-live-error-79e883a5.js';
import { c as has2WayAudio, a as hasAudio, s as setControlsOnVideo, h as hideMediaControlsTemporarily, M as MEDIA_LOAD_CONTROLS_HIDE_SECONDS, b as addAudioTracksMuteStateListener, V as VideoMediaPlayerController } from './audio-53bf6f1a.js';
...
let AdvancedCameraCardGo2RTC = class AdvancedCameraCardGo2RTC extends s {
    constructor() {
        super(...arguments);
        this.controls = false;
        this._message = null;
        this._mediaPlayerController = new VideoMediaPlayerController(this, () => this._player?.video ?? null, () => this.controls);
    }
    ...
    async _getPlayerSource() {
        ...
        let result = null;
        try {
            const endpoint = await createProxiedEndpointIfNecessary(this.hass, streamEndpoint, proxyConfig, {
                context: 'live',
            ...
            if (endpoint.sign) {
                result = await homeAssistantSignPath(this.hass, endpoint.endpoint, GO2RTC_URL_SIGN_EXPIRY_SECONDS);
                if (!result) {
                    this._handleError({
...
__decorate([
    n({ attribute: false })
], AdvancedCameraCardGo2RTC.prototype, "camera", void 0);
__decorate([
    n({ attribute: false })
], AdvancedCameraCardGo2RTC.prototype, "cameraEndpoints", void 0);
__decorate([
    n({ attribute: false })
], AdvancedCameraCardGo2RTC.prototype, "microphoneState", void 0);
__decorate([
    n({ attribute: false })
], AdvancedCameraCardGo2RTC.prototype, "microphoneConfig", void 0);
__decorate([
    n({ attribute: true, type: Boolean })
], AdvancedCameraCardGo2RTC.prototype, "controls", void 0);
__decorate([
    r$1()
], AdvancedCameraCardGo2RTC.prototype, "_message", void 0);
AdvancedCameraCardGo2RTC = __decorate([
    t('advanced-camera-card-live-go2rtc')
], AdvancedCameraCardGo2RTC);

export { AdvancedCameraCardGo2RTC };
//# sourceMappingURL=index-00de96ea.js.map
