import{d6 as e,_ as a,n as i,b as t,t as r,a as o,d7 as s,d8 as n,x as d,a4 as c,l,d9 as g,Q as h,da as m,r as v,d5 as p,db as u,dc as C,dd as I,de as M,df as _,dg as b}from"./card-03cad7f7.js";import{i as w}from"./media-dimensions-container-7e3416a0.js";import{L as y,d as f,M as D,a as A,A as $}from"./dispatch-live-error-cbb75d47.js";import{g as L}from"./live-provider-94a09520.js";class S{constructor(e){this._inBackground=!1,this._lastMediaLoadedInfo=null,this._handleMediaLoaded=e=>{this._lastMediaLoadedInfo={source:e.composedPath()[0],mediaLoadedInfo:e.detail},this._inBackground&&e.stopPropagation()},this._host=e,e.addController(this),this._intersectionObserver=new IntersectionObserver(this._intersectionHandler.bind(this))}hostConnected(){this._intersectionObserver.observe(this._host),this._host.addEventListener("advanced-camera-card:media:loaded",this._handleMediaLoaded)}hostDisconnected(){this._intersectionObserver.disconnect(),this._host.removeEventListener("advanced-camera-card:media:loaded",this._handleMediaLoaded)}isInBackground(){return this._inBackground}_intersectionHandler(a){const i=this._inBackground;this._inBackground=!a.some((e=>e.isIntersecting)),!this._inBackground&&this._lastMediaLoadedInfo&&e(this._lastMediaLoadedInfo.source,this._lastMediaLoadedInfo.mediaLoadedInfo),i!==this._inBackground&&this._host.requestUpdate()}}let N=class extends o{constructor(){super(),this.label="",this._isVideoMediaLoaded=!1,this._hasProviderError=!1,this._showStreamTroubleshooting=!1,this._refProvider=s(),this._lazyLoadController=new y(this),this._importPromises=[],this._lazyLoadController.addListener((e=>{e||(this._isVideoMediaLoaded=!1,n(this))}))}async getMediaPlayerController(){return await this.updateComplete,await(this._refProvider.value?.getMediaPlayerController())??null}_shouldShowImageDuringLoading(){return!(this._isVideoMediaLoaded||!this.camera?.getConfig()?.camera_entity||!this.hass||!this.liveConfig?.show_image_during_load||this._showStreamTroubleshooting||this._hasProviderError)}disconnectedCallback(){this._isVideoMediaLoaded=!1,super.disconnectedCallback()}_videoMediaShowHandler(){this._isVideoMediaLoaded=!0,this._showStreamTroubleshooting=!1}_providerErrorHandler(){this._hasProviderError=!0}willUpdate(e){if((e.has("liveConfig")||!this._lazyLoadController&&this.liveConfig)&&this._lazyLoadController.setConfiguration(this.liveConfig?.lazy_load,this.liveConfig?.lazy_unload),e.has("liveConfig")&&(this.liveConfig?.show_image_during_load&&this._importPromises.push(import("./image-635d990d.js")),this.liveConfig?.zoomable&&this._importPromises.push(import("./zoomer-51a0d47b.js"))),e.has("camera")){const e=L(this.camera?.getConfig());"jsmpeg"===e?this._importPromises.push(import("./jsmpeg-a0f67310.js")):"ha"===e?this._importPromises.push(import("./ha-cc363eef.js")):"webrtc-card"===e?this._importPromises.push(import("./webrtc-card-b9427573.js")):"image"===e?this._importPromises.push(import("./image-635d990d.js")):"go2rtc"===e&&this._importPromises.push(import("./index-8cfea72c.js"))}}async getUpdateComplete(){const e=await super.getUpdateComplete();return await Promise.all(this._importPromises),this._importPromises=[],e}_renderContainer(e){const a=this.camera?.getConfig(),i=d` <advanced-camera-card-media-dimensions-container
    ...
    >
      ${e}
        ...
        >
          ${i}
        </advanced-camera-card-zoomer>`:i}`}render(){const e=this.camera?.getConfig();if(!(this._lazyLoadController?.isLoaded()&&this.hass&&this.liveConfig&&this.camera&&e))return;this.title=this.label,this.ariaLabel=this.label;const a=L(this.camera?.getConfig());if("ha"===a||"image"===a||e?.camera_entity&&e.always_error_if_entity_unavailable){if(!e?.camera_entity)return f(this),c({message:l("error.no_live_camera"),type:"error",icon:"mdi:camera",context:e});const a=this.hass.states[e.camera_entity];if(!a)return f(this),c({message:l("error.live_camera_not_found"),type:"error",icon:"mdi:camera",context:e});if("unavailable"===a.state)return f(this),n(this),c({message:`${l("error.live_camera_unavailable")}${this.label?`: ${this.label}`:""}`,type:"info",icon:"mdi:cctv-off",dotdotdot:!0})}const i=this._shouldShowImageDuringLoading(),t=!this._isVideoMediaLoaded,r={hidden:i};return d`${this._renderContainer(d`
    ...
    >
      ...
      <advanced-camera-card-carousel
        ...
        @advanced-camera-card:media:loaded=${s}
        @advanced-camera-card:media:unloaded=${n}
      >
    ...
    `}static get styles(){return v(b)}};a([i({attribute:!1})],x.prototype,"hass",void 0),a([i({attribute:!1})],x.prototype,"viewManagerEpoch",void 0),a([i({attribute:!1})],x.prototype,"liveConfig",void 0),a([i({attribute:!1})],x.prototype,"cameraManager",void 0),a([i({attribute:!1})],x.prototype,"cardWideConfig",void 0),a([i({attribute:!1})],x.prototype,"microphoneState",void 0),a([i({attribute:!1})],x.prototype,"triggeredCameraIDs",void 0),x=a([r("advanced-camera-card-live")],x);export{x as AdvancedCameraCardLive};
