import{dW as e,_ as a,x as i,y as t,t as r,u as o,Y as s,dX as n,C as d,a4 as c,l,a0 as m,J as h,dY as g,v,dV as C,dZ as p,d_ as u,M as I,g as M,a8 as _,a2 as w}from"./card-0548e5ec.js";import{i as b}from"./media-dimensions-container-b05a8c06.js";import{L as f,d as y,M as A,a as $,A as D}from"./dispatch-live-error-5459541f.js";import{g as j}from"./live-provider-3a9e42e1.js";class L{constructor(e){this._inBackground=!1,this._lastMediaLoadedInfo=null,this._handleMediaLoaded=e=>{this._lastMediaLoadedInfo={source:e.composedPath()[0],mediaLoadedInfo:e.detail},this._inBackground&&e.stopPropagation()},this._host=e,e.addController(this),this._intersectionObserver=new IntersectionObserver(this._intersectionHandler.bind(this))}hostConnected(){this._intersectionObserver.observe(this._host),this._host.addEventListener("advanced-camera-card-mini:media:loaded",this._handleMediaLoaded)}hostDisconnected(){this._intersectionObserver.disconnect(),this._host.removeEventListener("advanced-camera-card-mini:media:loaded",this._handleMediaLoaded)}isInBackground(){return this._inBackground}_intersectionHandler(a){const i=this._inBackground;this._inBackground=!a.some((e=>e.isIntersecting)),!this._inBackground&&this._lastMediaLoadedInfo&&e(this._lastMediaLoadedInfo.source,this._lastMediaLoadedInfo.mediaLoadedInfo),i!==this._inBackground&&this._host.requestUpdate()}}let S=class extends o{constructor(){super(),this.label="",this._isVideoMediaLoaded=!1,this._hasProviderError=!1,this._showStreamTroubleshooting=!1,this._refProvider=s(),this._lazyLoadController=new f(this),this._importPromises=[],this._lazyLoadController.addListener((e=>{e||(this._isVideoMediaLoaded=!1,n(this))}))}async getMediaPlayerController(){return await this.updateComplete,await(this._refProvider.value?.getMediaPlayerController())??null}_shouldShowImageDuringLoading(){return!(this._isVideoMediaLoaded||!this.camera?.getConfig()?.camera_entity||!this.hass||!this.liveConfig?.show_image_during_load||this._showStreamTroubleshooting||this._hasProviderError)}disconnectedCallback(){this._isVideoMediaLoaded=!1,super.disconnectedCallback()}_videoMediaShowHandler(){this._isVideoMediaLoaded=!0,this._showStreamTroubleshooting=!1}_providerErrorHandler(){this._hasProviderError=!0}willUpdate(e){if((e.has("liveConfig")||!this._lazyLoadController&&this.liveConfig)&&this._lazyLoadController.setConfiguration(this.liveConfig?.lazy_load,this.liveConfig?.lazy_unload),e.has("liveConfig")&&(this.liveConfig?.show_image_during_load&&this._importPromises.push(import("./image-1b0fbc09.js")),this.liveConfig?.zoomable&&this._importPromises.push(import("./zoomer-c8f17f8e.js"))),e.has("camera")){const e=j(this.camera?.getConfig());"jsmpeg"===e?this._importPromises.push(import("./jsmpeg-e85844c8.js")):"ha"===e?this._importPromises.push(import("./ha-397a82ad.js")):"webrtc-card"===e?this._importPromises.push(import("./webrtc-card-3a17b649.js")):"image"===e?this._importPromises.push(import("./image-1b0fbc09.js")):"go2rtc"===e&&this._importPromises.push(import("./index-9dc7bb25.js"))}}async getUpdateComplete(){const e=await super.getUpdateComplete();return await Promise.all(this._importPromises),this._importPromises=[],e}_renderContainer(e){const a=this.camera?.getConfig(),i=d` <advanced-camera-card-mini-media-dimensions-container
    ...
    >
      ${e}
          ...
          .defaultSettings=${b([a?.dimensions?.layout],(()=>a?.dimensions?.layout?{pan:a.dimensions.layout.pan,zoom:a.dimensions.layout.zoom}:void 0))}
    ...
    >
      ...
      <advanced-camera-card-mini-carousel
        ...
        @advanced-camera-card-mini:media:loaded=${s}
        @advanced-camera-card-mini:media:unloaded=${n}
      >
    ...
    `}static get styles(){return v(w)}};a([t({attribute:!1})],z.prototype,"hass",void 0),a([t({attribute:!1})],z.prototype,"viewManagerEpoch",void 0),a([t({attribute:!1})],z.prototype,"liveConfig",void 0),a([t({attribute:!1})],z.prototype,"cameraManager",void 0),a([t({attribute:!1})],z.prototype,"cardWideConfig",void 0),a([t({attribute:!1})],z.prototype,"microphoneState",void 0),a([t({attribute:!1})],z.prototype,"triggeredCameraIDs",void 0),z=a([r("advanced-camera-card-mini-live")],z);export{z as AdvancedCameraCardLive};
