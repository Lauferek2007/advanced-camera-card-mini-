    ...
    `}render(){const e=!!this.viewManagerEpoch?.manager.getView()?.context?.loading?.query;return h`
      ...
      >
        ...
        ${this._controller.getMedia()?.length?h`<advanced-camera-card-mini-gallery-core
            ...
            </advanced-camera-card-mini-gallery-core>`:g({type:"info",message:u(e?"error.awaiting_media":"common.no_media"),icon:"mdi:multimedia",dotdotdot:e})}
      </advanced-camera-card-mini-surround-basic>
