import { u as s, E as Timer, e5 as dispatchMediaPlayEvent, e6 as dispatchMediaPauseEvent, e3 as dispatchMediaLoadedEvent, l as localize, eb as homeAssistantSignPath, B as errorToConsole, fp as convertHTTPAdressToWebsocket, a4 as renderMessage, C as x, ec as renderProgressIndicator, v as r, _ as __decorate, y as n, x as r$1, t } from './card-edc26888.js';
...
class JSMPEGMediaPlayerController {
    constructor(host, _getJSMPEGVideoElementCallback, _getCanvasElementCallback) {
        this._host = host;
...
let AdvancedCameraCardLiveJSMPEG = class AdvancedCameraCardLiveJSMPEG extends s {
    constructor() {
        super(...arguments);
        this._message = null;
        this._refreshPlayerTimer = new Timer();
        this._mediaPlayerController = new JSMPEGMediaPlayerController(this, () => this._jsmpegVideoPlayer ?? null, () => this._jsmpegCanvasElement ?? null);
    }
    ...
    async _createJSMPEGPlayer(url) {
        this._jsmpegVideoPlayer = await new Promise((resolve) => {
    ...
    async _refreshPlayer() {
        ...
        let response;
        try {
            response = await homeAssistantSignPath(this.hass, endpoint.endpoint, JSMPEG_URL_SIGN_EXPIRY_SECONDS);
        }
        catch (e) {
            errorToConsole(e);
        }
        ...
        this._refreshPlayerTimer.start(JSMPEG_URL_SIGN_EXPIRY_SECONDS - JSMPEG_URL_SIGN_REFRESH_THRESHOLD_SECONDS, () => this.requestUpdate());
    }
    render() {
        if (this._message) {
        ...
        const _render = async () => {
            ...
            return x `${this._jsmpegCanvasElement}`;
        };
        return x `${m(_render(), renderProgressIndicator({
...
__decorate([
    n({ attribute: false })
], AdvancedCameraCardLiveJSMPEG.prototype, "cameraConfig", void 0);
__decorate([
    n({ attribute: false })
], AdvancedCameraCardLiveJSMPEG.prototype, "cameraEndpoints", void 0);
__decorate([
    n({ attribute: false })
], AdvancedCameraCardLiveJSMPEG.prototype, "cardWideConfig", void 0);
__decorate([
    r$1()
], AdvancedCameraCardLiveJSMPEG.prototype, "_message", void 0);
AdvancedCameraCardLiveJSMPEG = __decorate([
    t('advanced-camera-card-live-jsmpeg')
], AdvancedCameraCardLiveJSMPEG);

export { AdvancedCameraCardLiveJSMPEG };
//# sourceMappingURL=jsmpeg-3bc77516.js.map
