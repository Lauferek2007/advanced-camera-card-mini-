...
@customElement('advanced-camera-card-mini-media-dimensions-container')
...
declare global {
  interface HTMLElementTagNameMap {
    'advanced-camera-card-mini-media-dimensions-container': AdvancedCameraCardMediaDimensionsContainer;
  }
}
