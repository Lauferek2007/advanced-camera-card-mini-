...
import { fireAdvancedCameraCardEvent } from '../../src/utils/fire-advanced-camera-card-mini-event.js';
...
describe('fireAdvancedCameraCardEvent', () => {
  it('should fire event without data', () => {
    ...
    const handler = vi.fn();
    element.addEventListener('advanced-camera-card-mini:foo', handler);
